...
public class GitHubAPIHttpClient {
        ...
        try {
            ...
            switch(jsonResponse.getStatus()) {
                ...
                case 403:
                    ...
                    log.info(String.format("Your remaining call is %s", XRateRemaining));
    ...
    protected  HttpResponse<JsonNode> getNextIssuesAPI(Integer page,
                                                       Instant since) throws UnirestException {
