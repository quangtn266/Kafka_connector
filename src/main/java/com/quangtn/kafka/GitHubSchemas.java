...
public class GitHubSchemas {
    ...
    // Schema names
    public static final String SCHEMA_KEY = "com.quangtn.kafka.connect.github.IssueKey";
    public static final String SCHEMA_VALUE_ISSUE = "com.quangtn.kafka.connect.github.IssueValue";
    public static final String SCHEMA_VALUE_USER = "com.quangtn.kafka.connect.github.UserValue";
    public static final String SCHEMA_VALUE_PR = "com.quangtn.kafka.connect.github.PrValue";
