...
import com.quangtn.kafka.Validators.BatchSizeValidator;
import com.quangtn.kafka.Validators.TimestampValidator;
...
public class GitHubSinkConnectorConfig extends AbstractConfig {
  ...
  private static final String TOPIC_DOC = "This is a setting important to my connector.";
  ...
  private static final String AUTH_USERNAME_DOC = "Optional Username to authenticat calls";
