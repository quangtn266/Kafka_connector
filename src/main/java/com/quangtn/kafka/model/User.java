package com.quangtn.kafka.model;
...
public class User {
    ...
    /**
     * No args connectors for use in serialization
     *
     */
    public User() {
    }
    ...
    public void setFollowersUrl(String followingUrl) {
        this.followingUrl = followingUrl;
    }

    public User withFollowerUrl(String followersUrl) {
        this.followingUrl = followersUrl;
        return this;
    }
    ...
    public User withGistUrl(String gistsUrl) {
        this.gistsUrl = gistsUrl;
        return this;
    }
    ...
    public User withSubcriptionsUrl(String subscriptionsUrl) {
        this.subscriptionsUrl = subscriptionsUrl;
        return this;
    }
